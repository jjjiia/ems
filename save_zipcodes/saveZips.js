...
var boundaries = d3.json("zipcode.geojson")
...
//    console.log(centroidsData)
  ...
  //  gids = nycGeoids.sort()
    ...
    gids = Object.keys(boundariesData)
    console.log(gids)
    // var notFinished = []
 //    for(var g in gids){
...
//    var center = [centroidsData[currentId]["lng"],centroidsData[currentId]["lat"]]
    ...
    var map = new mapboxgl.Map({
        container: 'map',
        style: 'mapbox://styles/jjjiia123/cknrw1rqq13pr17o3te0tnhqi',
        //center:center,
        zoom: pub.zoom,
...
//console.log(gidsList)
	...
	//	console.log(center,currentId)
        ...
        map.on("mousemove","zip",function(c){
...
function makeBoundaryDictionary(data){
    ...
    for(var i in data.features){
       // console.log(data.features[i])
        var geoid = data.features[i].properties["ZIPCODE"]
	...
	//console.log([gid, bearing])
        ...
        console.log(userBounds)
                ...
                map.once('moveend',function(){
					//console.log(gid)
				    var filter = ['!=', 'ZIPCODE',gid];
					map.setFilter("zip",filter)
